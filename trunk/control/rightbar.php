			<div id="rightbar">
				...
				<div class="rating">
					<h2 style="margin: 0;"><img style="margin-right: 10px;" src="images/ico_esc.gif"><?php trp('Squadrons'); ?></h2>
					<table>
						<tr>
							<td class="num num_red">1</td>
				...
				<div id="tracks">
					...
					<div style=" width: 199px; height: 20px; padding: 5px 0 0 5px; margin: 0 0 5px 0; background: #243; font-size: 11px;" colspan="2"><a style="color: #cc3; border-bottom: 1px solid;" href="#"><?php trp('View all'); ?></a></div>
				</div>
			</div> <!--rightbar-->
